...
function UpdateCart()
{
	...
	if(cart_products.length>0)
	{
		...
		cart_html+='<tr>';
		cart_html+='<th>No</th>';
		cart_html+='<th>Item Name</th>';
		cart_html+='<th>Unit Price</th>';
		cart_html+='<th width="30">Qty</th>';
		cart_html+='<th>Amount</th>';
		cart_html+='<th>Remove</th>';
		cart_html+='</tr>';
		cart_html+='</thead>';
		cart_html+='<tbody>';
		...
		for(var i=0;i<cart_products.length;i++)
		{
			...
			cart_html+='<td><input type="hidden" name="unitPrice_'+inx+'" id="unitPrice_'+inx+'" value="'+product_prices[cart_products[i]]+'" />'+product_prices[cart_products[i]]+' '+currency_symbol[cart_products[i]]+'</td>';
			...
			cart_html+='<td>'+(product_prices[cart_products[i]]*cart_quantities[cart_products[i]])+' '+currency_symbol[cart_products[i]]+'</td>';
			...
			print+='<td style="padding-left:5%">'+product_prices[cart_products[i]]+' '+currency_symbol[cart_products[i]]+'</td>';
			print+='<td style="text-align:center;">'+cart_quantities[cart_products[i]]+'</td>';
			print+='<td style="padding-left:5%">'+(product_prices[cart_products[i]]*cart_quantities[cart_products[i]])+' '+currency_symbol[cart_products[i]]+'</td>';
			print+='</tr>';
		...
		cart_html+='<div class="row-fluid" style="margin-top:10px">';
			...
			cart_html+='<div class="span6">';
				cart_html+='<div class="total">';
					cart_html+='<div class="span6">';
						cart_html+='<p><strong><span>Subtotal Reil</span></strong></p>';
					cart_html+='</div>';
					cart_html+='<div class="span2">';
						cart_html+='<p><strong><span>:</span></strong></p>';
					cart_html+='</div>';
					cart_html+='<div class="span4">';
						cart_html+='<p><strong>'+subtotal_reil+' <em style="float: right;padding-right: 10%;"> Reil</em></strong></p>';
					cart_html+='</div>';
				cart_html+='</div>';
				cart_html+='<div class="total">';
					cart_html+='<div class="span6">';
						cart_html+='<p><strong><span>Subtotal Dollar</span></strong></p>';
					cart_html+='</div>'; 
					cart_html+='<div class="span2">';
						cart_html+='<p><strong><span>:</span></strong></p>';
					cart_html+='</div>';
					cart_html+='<div class="span4">';
						cart_html+='<input type="hidden" name="total" id="total" value="'+subtotal_reil+'" /><p><strong>'+subtotal_dollar+' <em style="float: right;padding-right: 10%;"> USD</em></strong></p>';
					cart_html+='</div>';
				cart_html+='</div>';
			cart_html+='</div>';
		cart_html+='</div>';
		...
		print+='<div class="row-form" style="width:100%; padding:0;">';
			...
			print+='<div style="width:60%; padding:0; float: left"> ';
				print+='<div style="width:100%; padding:0;float: left;">';
					print+='<div style="width:55%;float: left;text-align: left;">Subtotal Reil(៛)</div>';
					print+='<div style="float: left;">:</div>';
					print+='<div style="width:35%;float: right;padding-right:10px;text-align: right;">'+subtotal_reil+'(៛)</div>';
				print+='</div>';
				print+='<div style="width:100%; padding:0;float: left;">';
					print+='<div style="width:55%;float: left;text-align: left;">Subtotal Dollar($)</div>';
					print+='<div style="float: left;">:</div>';
					print+='<div style="width:35%;float: right;padding-right:10px;text-align: right;">'+subtotal_dollar+'($)</div>';
				print+='</div>';
			print+='</div>';
		print+='</div>';
	}
...
function InitList()
{
	...
	{
		cart_html+='<table cellpadding="0" cellspacing="0" width="100%">';
		cart_html+='<thead>';
		cart_html+='<tr>';
		cart_html+='<th>No</th>';
		cart_html+='<th>Item Name</th>';
		...
		print+='<table style="width: 100%; border:0 0 0px 0 solid #DDD;position: relative;padding: 0px;margin: 0px;border-spacing: 0px;border-collapse: collapse;">';
		print+='<thead>';
		print+='<tr style="border-bottom: 1px solid #DDD;font-size: 9px; background-color: #F2EDED !important;">';
		print+='<th>No</th>';
		print+='<th>Item Description</th>';
		...
		for(var i=0;i<javaArray.length;i++)
		{
			...
			cart_html+='<tr>';
			cart_html+='<td align="center">'+inx+'</td>';
			cart_html+='<td><input type="hidden" name="proId_'+inx+'" id="proId_'+inx+'" value="'+proId[javaArray[i]]+'" />'+javaArray[pro_name_en[i]]+'</td>';
			cart_html+='<td><input type="hidden" name="unitPrice_'+inx+'" id="unitPrice_'+inx+'" value="'+product_prices[cart_products[i]]+'" />'+product_prices[cart_products[i]]+'</td>';
			cart_html+='<td width="40px"><input style="text-align:center;" name="quantity_'+inx+'" id="quantity_'+cart_products[i]+'" type="text" value="'+cart_quantities[cart_products[i]]+'" maxlength="3" Onchange="ProceedUpdate();" class="quantity-text"/></td>';
			cart_html+='<td>'+(product_prices[cart_products[i]]*cart_quantities[cart_products[i]])+'</td>';
			cart_html+='<td align="center"><span style="cursor:pointer" Onclick="DeleteItem('+cart_products[i]+')" class="icon-trash"></span></td>';
			cart_html+='</tr>';
			...
			print+='<td align="center">'+inx+'</td>';
			print+='<td style="padding-left:5%">'+products[cart_products[i]]+'</td>';
			print+='<td style="padding-left:5%">'+product_prices[cart_products[i]]+'</td>';
			print+='<td style="text-align:center;">'+cart_quantities[cart_products[i]]+'</td>';
			print+='<td style="padding-left:5%">'+(product_prices[cart_products[i]]*cart_quantities[cart_products[i]])+'</td>';
			print+='</tr>';
		...
		cart_html+='<div class="row-fluid" style="margin-top:10px">';
			cart_html+='<div class="span8"></div>';
			cart_html+='<div class="span4">';
				cart_html+='<div class="total">';
					cart_html+='<div class="span6">';
						cart_html+='<p><strong><span>Subtotal:</span></strong></p>';
					cart_html+='</div>';
					cart_html+='<div class="span6">';
						cart_html+='<p><strong>'+subtotal+' <em>USD</em></strong></p>';
					cart_html+='</div>';
				cart_html+='</div>';
				cart_html+='<div class="total">';
					cart_html+='<div class="span6">';
					...
					cart_html+='</div>';
					cart_html+='<div class="span6">';
						cart_html+='<input type="hidden" name="total" id="total" value="'+subtotal+'" /><p><strong>'+subtotal+' <em>USD</em></strong></p>';
					cart_html+='</div>';
				cart_html+='</div>';
			cart_html+='</div>';
		cart_html+='</div>';
		...
		print+='<div style="height: 30px;"></div> ';
		print+='<div class="row-form" style="width:100%; padding:0;">';
			print+='<div style="width:50%; padding:0; float: left">&nbsp;</div>';
			print+='<div style="width:50%; padding:0; float: left"> ';
				print+='<div style="width:100%; padding:0;float: left;">';
					print+='<div style="50%;float: left;">Subtotal : </div>';
					print+='<div style="50%;float: right;padding-right:20px">'+subtotal+'</div>';
				print+='</div>';
				print+='<div style="width:100%; padding:0;float: left;">';
					print+='<div style="50%;float: left;">Subtotal : </div>';
					print+='<div style="50%;float: right;padding-right:20px">'+subtotal+'</div>';
